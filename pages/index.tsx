        ...
        <div className={ homeStyles.home }>
          ...
          <div className={ homeStyles.home__mixte }>
            ...
            <div className={layoutStyles.panel}>
              <IconComponent name={ IconName.Arrow }/>
            </div>
            <p className={ homeStyles.home__mixte_p }>
              Savant mélange de rugby, de handball et de dodgeball, le quidditch a bien évolué depuis sa version fictive
              créée en 2005.
            ...
            <div>
              <p className={`${homeStyles.home__mixte_h2} ${layoutStyles.panel}`}>
                UN SPORT POUR TOU.TE.S
              </p>
            </div>
          </div>
        </div>
